...
function Controller() {
    ...
    function displayAdv() {
        function toTestAdv() {
            ...
            adView = Admob.createView({
                width: 320,
                height: 50,
                publisherId: "ca-app-pub-4666117465588141/6097002869",
                adBackgroundColor: "white",
                dateOfBirth: new Date(1981, 30, 5)
            });
            $.adContainer.add(adView);
        }
        var publisherId = "/5902/fcinter/mobile_app_android";
    ...
    $.newsList.addEventListener("scroll", function(e) {
        e.firstVisibleItem + e.visibleItemCount == e.totalItemCount && startUpdateNews(currentCategory);
    });
